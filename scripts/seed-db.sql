...
SELECT 'admin@gym.com', '$2b$10$rOzJqQqQqQqQqQqQqQqQqOzJqQqQqQqQqQqQqQqQqOzJqQqQqQqQqu', 'Gym Administrator'
WHERE NOT EXISTS (SELECT 1 FROM admin_users WHERE email = 'admin@gym.com');
...
UPDATE fee_records SET paid_date = '2024-01-18' WHERE status = 'paid' AND paid_date IS NULL;
